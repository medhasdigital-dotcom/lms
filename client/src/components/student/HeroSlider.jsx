...
function mapCoursesToSlides(courses) {
  return courses.map(course => ({
    ...
    descDesktop: stripHtml(course.courseDescription).slice(0, 180) + "...",
    descMobile: stripHtml(course.courseDescription).slice(0, 90) + "...",
                ...
                <div className={`space-y-6 text-center md:text-left transition-all duration-700 ${
                  ...
                  <div className="flex items-center justify-center md:justify-start gap-6 text-sm text-gray-500">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span>{slide.enrolledCount || '2.5k+'} students</span>
                    </div>
                  </div>
                  ...
                  {slide.price > 0 && (
                    <div className="flex items-center justify-center md:justify-start gap-3 pt-2">
                      <span className="text-3xl font-bold text-gray-900">
                        ${(slide.price - (slide.price * slide.discount / 100)).toFixed(0)}
                      </span>
                      {slide.discount > 0 && (
                        <>
                          <span className="text-lg text-gray-400 line-through">${slide.price}</span>
